...
mkdir -p 74_gnome-icon-theme-symbolic
...
make clean
make 2>&1 | tee ${LOGPREFIX}_74_gnome-icon-theme-symbolic-make.log
make install 2>&1 | tee ${LOGPREFIX}_74_gnome-icon-theme-symbolic-makeinstall.log
